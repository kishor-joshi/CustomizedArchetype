...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.atmecs.utility;
...
public static final String extendReportPath="./src/main/resources/extendReport/atmecsExtendReport.html";
public static final String driverPropertiesFilePath="./src/main/resources/locators/driverdata.properties";
}
